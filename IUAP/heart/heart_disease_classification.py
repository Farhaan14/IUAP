...
Original file is located at
    https://colab.research.google.com/drive/1I270Qe1yty8Ij8wSte-nE4BLrYCvrN6E
"""
...
sns.distplot(df[df['target'] == 0]['age'], label='Have heart disease')
...
for cls in [logre]:
    ...
    results[cls_name] = {}
    results[cls_name] = fit_eval_model(logre, X_train, y_train, X_test, y_test)
